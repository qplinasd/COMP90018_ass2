...
public class ImagePagerActivity extends AppCompatActivity implements ImageDetailFragment.OnLoadListener{
    ...
    public static void startImagePage(Activity context, ArrayList<Integer> urls, int pos, @Nullable View view) {
    ...
    private void initView() {
        mImgs = getIntent().getIntegerArrayListExtra(EXTRA_IMAGE_URLS);
